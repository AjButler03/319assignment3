...
const DeleteProduct = () => {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(
        `http://localhost:8081/deleteProduct/${productId}`,
        {
          method: "DELETE",
        }
      );
          ...
          products.map((product) => (
            ...
            >
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">
                  <strong>Rating Rate:</strong> {product.rating.rate}
                </li>
                <li className="list-group-item">
              ...
              <div className="accordion-body">
                <div className="album py-5">
                  <div className="container">
                    ...
                    <h4>Assignment 3 objective</h4>
                    <p>
                      The goal with this assignment was to create a MERN
                      website; i.e., a website using MongoDB, Express, React,
                      and NodeJS. We have implemented both a backend NodeJS app
                      to manage the information from a MongoDB database of
                      products, and used a React app frontend to create a user
                      friendly interface to access and modify that database.
                    </p>
